...
public class FinalLevel extends World
{
    ...
    Maze maze;
    GreenfootSound backgroundMusic = new GreenfootSound("Crappy Video Game BGM.wav");
    /**
    ...
    public void prepare()
    {
        ...
        EndMessage1 endmessage1 = new EndMessage1();
        addObject(endmessage1, 180, 268);
        EndMessage2 endmessage2 = new EndMessage2();
        addObject(endmessage2, 295, 390);
        EndMessage3 endmessage3 = new EndMessage3();
        addObject(endmessage3, 418, 269);
        Explorer explorer = new Explorer();
        addObject(explorer, 30, 330);
        Flashlight flashlight = new Flashlight();
        addObject(flashlight, 300, 300);
        flashlight.setRadius(100);
        Battery battery = new Battery();
        addObject(battery, 573, 332);
